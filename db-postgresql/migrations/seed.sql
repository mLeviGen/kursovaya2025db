...
-- партия через функцию (best_before поставит триггер)
...
-- тест качества через функцию (триггер обновит статус партии)
...
-- заказ через функцию (unit_price заполнит триггер)
